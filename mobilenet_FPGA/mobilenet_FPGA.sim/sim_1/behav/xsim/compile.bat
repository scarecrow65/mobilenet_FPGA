...
REM
REM Generated by Vivado on Wed Feb 11 23:20:18 +0530 2026
...
echo "xvlog --incr --relax -prj weight_buffer_vlog.prj"
call xvlog  --incr --relax -prj weight_buffer_vlog.prj -log xvlog.log
